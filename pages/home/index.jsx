    ...
    <>
      ...
      <section className="h-screen">
        <div className="container my-14">
          <h1 className="text-3xl tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
            <span className="block">Discover the wonders</span>
          </h1>
          <h1 className="text-3xl my-2 tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
